 ...
 */
class GetJobStatusResponseFormatOpts extends JsonSerializableType
{
    /**
     * @var ?float $fromPage
     */
    ...
    /**
     * @var ?value-of<GetJobStatusResponseFormatOptsFormat> $format
     */
    #[JsonProperty('format')]
     ...
     *   fromPage?: ?float,
     *   toPage?: ?float,
     *   format?: ?value-of<GetJobStatusResponseFormatOptsFormat>,
